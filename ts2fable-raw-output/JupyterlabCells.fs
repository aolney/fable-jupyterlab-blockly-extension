...
module Celldragutils =
    ...
    module CellDragUtils =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract createCellDragImage: activeCell: Cell * selectedCells: ResizeArray<Nbformat.ICell> -> HTMLElement
...
module Inputarea =
    ...
    type CodeEditorWrapper = __@jupyterlab_codeeditor.CodeEditorWrapper
    ...
    type [<AllowNullLiteral>] InputArea =
        ...
        abstract editor: CodeEditor.IEditor
    ...
    module InputArea =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract defaultEditorFactory: CodeEditor.Factory
        ...
        type [<AllowNullLiteral>] IContentFactory =
            ...
            /// to pass it around.
            abstract editorFactory: CodeEditor.Factory
        ...
        module ContentFactory =
            ...
            type [<AllowNullLiteral>] IOptions =
                ...
                /// will be used.
                abstract editorFactory: CodeEditor.Factory option with get, set
...
module Model =
    ...
    type Signal = __@phosphor_signaling.Signal
    type IAttachmentsModel = __@jupyterlab_attachments.IAttachmentsModel
    type CodeEditor = __@jupyterlab_codeeditor.CodeEditor
    ...
    type IObservableValue = __@jupyterlab_observables.IObservableValue
    type ObservableValue = __@jupyterlab_observables.ObservableValue
    type IOutputAreaModel = __@jupyterlab_outputarea.IOutputAreaModel
    ...
    type [<AllowNullLiteral>] ICodeCellModel =
        ...
        /// Serialize the model to JSON.
        abstract toJSON: unit -> Nbformat.ICodeCell
        /// The code cell's prompt number. Will be null if the cell has not been run.
        abstract executionCount: Nbformat.ExecutionCount with get, set
        /// The cell outputs.
    ...
    type [<AllowNullLiteral>] IMarkdownCellModel =
        ...
        abstract ``type``: string
        /// Serialize the model to JSON.
        abstract toJSON: unit -> Nbformat.IMarkdownCell
    ...
    type [<AllowNullLiteral>] IRawCellModel =
        ...
        abstract ``type``: string
        /// Serialize the model to JSON.
        abstract toJSON: unit -> Nbformat.IRawCell
    ...
    type [<AllowNullLiteral>] CellModel =
        ...
        /// A signal emitted when a model state changes.
        abstract stateChanged: Signal<CellModel, IChangedArgs<obj option, string>>
        /// The id for the cell.
        abstract id: string
        /// The metadata associated with the cell.
        abstract metadata: IObservableJSON
        ...
        abstract onTrustedChanged: trusted: IObservableValue * args: ObservableValue.IChangedArgs -> unit
    ...
    module CellModel =
        ...
        type [<AllowNullLiteral>] IOptions =
            ...
            abstract cell: Nbformat.IBaseCell option with get, set
    ...
    type [<AllowNullLiteral>] AttachmentsCellModel =
        ...
        abstract attachments: IAttachmentsModel
        /// Serialize the model to JSON.
        abstract toJSON: unit -> U2<Nbformat.IRawCell, Nbformat.IMarkdownCell>
    ...
    module AttachmentsCellModel =
        ...
        type [<AllowNullLiteral>] IContentFactory =
            ...
            abstract createAttachmentsModel: options: IAttachmentsModel.IOptions -> IAttachmentsModel
    ...
    module CodeCellModel =
        ...
        type [<AllowNullLiteral>] IContentFactory =
            /// Create an output area.
            abstract createOutputArea: options: IOutputAreaModel.IOptions -> IOutputAreaModel
...
module Widget =
    ...
    type OutputArea = __@jupyterlab_outputarea.OutputArea
    type IOutputPrompt = __@jupyterlab_outputarea.IOutputPrompt
    type IStdin = __@jupyterlab_outputarea.IStdin
    type Stdin = __@jupyterlab_outputarea.Stdin
    type IRenderMimeRegistry = __@jupyterlab_rendermime.IRenderMimeRegistry
    type KernelMessage = __@jupyterlab_services.KernelMessage
    ...
    type [<AllowNullLiteral>] Cell =
        ...
        abstract onMetadataChanged: model: IObservableMap<JSONValue> * args: IObservableMap.IChangedArgs<JSONValue> -> unit
    ...
    module Cell =
        ...
        /// widgets.
        type [<AllowNullLiteral>] IContentFactory =
            inherit OutputArea.IContentFactory
            inherit InputArea.IContentFactory
    ...
    type [<AllowNullLiteral>] CodeCell =
        ...
        abstract onStateChanged: model: ICellModel * args: IChangedArgs<obj option> -> unit
        /// Handle changes in the metadata.
        abstract onMetadataChanged: model: IObservableMap<JSONValue> * args: IObservableMap.IChangedArgs<JSONValue> -> unit
    ...
    module CodeCell =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract execute: cell: CodeCell * session: IClientSession * ?metadata: JSONObject -> Promise<U2<KernelMessage.IExecuteReplyMsg, unit>>
