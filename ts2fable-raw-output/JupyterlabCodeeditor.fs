...
module Editor =
    ...
    type IObservableString = __@jupyterlab_observables.IObservableString
...
module Factory =
    ...
    type [<AllowNullLiteral>] IEditorFactoryService =
        ...
        abstract newInlineEditor: options: CodeEditor.IOptions -> CodeEditor.IEditor
        /// Create a new editor for a full document.
        abstract newDocumentEditor: options: CodeEditor.IOptions -> CodeEditor.IEditor
...
module Jsoneditor =
    ...
    type [<AllowNullLiteral>] JSONEditor =
        ...
        abstract model: CodeEditor.IModel
...
module Mimetype =
    ...
    type [<AllowNullLiteral>] IEditorMimeTypeService =
        ...
        abstract getMimeTypeByLanguage: info: Nbformat.ILanguageInfoMetadata -> string
...
module Widget =
    ...
    module CodeEditorWrapper =
        ...
        type [<AllowNullLiteral>] IOptions =
            ...
            abstract factory: CodeEditor.Factory with get, set
            /// The model used to initialize the code editor.
            abstract model: CodeEditor.IModel with get, set
            /// The desired uuid for the editor.
            abstract uuid: string option with get, set
            /// The configuration options for the editor.
            abstract config: obj option with get, set
            /// The default selection style for the editor.
            abstract selectionStyle: CodeEditor.ISelectionStyle option with get, set
