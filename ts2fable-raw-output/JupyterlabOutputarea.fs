...
module Model =
    ...
    type IOutputModel = __@jupyterlab_rendermime.IOutputModel
    ...
    type [<AllowNullLiteral>] IOutputAreaModel =
        ...
        abstract add: output: Nbformat.IOutput -> float
        /// Set the value at the specified index.
        abstract set: index: float * output: Nbformat.IOutput -> unit
        ...
        abstract fromJSON: values: ResizeArray<Nbformat.IOutput> -> unit
        /// Serialize the model to JSON.
        abstract toJSON: unit -> ResizeArray<Nbformat.IOutput>
    ...
    module IOutputAreaModel =
        ...
        type [<AllowNullLiteral>] IOptions =
            ...
            abstract values: ResizeArray<Nbformat.IOutput> option with get, set
        ...
        type ChangedArgs =
            IObservableList.IChangedArgs<IOutputModel>

        /// The interface for an output content factory.
        type [<AllowNullLiteral>] IContentFactory =
            /// Create an output model.
            abstract createOutputModel: options: IOutputModel.IOptions -> IOutputModel
    ...
    type [<AllowNullLiteral>] OutputAreaModel =
        ...
        abstract get: index: float -> IOutputModel
        /// Set the value at the specified index.
        abstract set: index: float * value: Nbformat.IOutput -> unit
        /// Add an output, which may be combined with previous output.
        abstract add: output: Nbformat.IOutput -> float
        /// <summary>Clear all of the output.</summary>
        /// <param name="wait">Delay clearing the output until the next message is added.</param>
        ...
        abstract list: IObservableList<IOutputModel> with get, set
...
module Widget =
    ...
    type [<AllowNullLiteral>] OutputArea =
        ...
        abstract future: Kernel.IShellFuture<KernelMessage.IExecuteRequestMsg, KernelMessage.IExecuteReplyMsg> option with get, set
        /// Dispose of the resources used by the output area.
        abstract dispose: unit -> unit
        /// Follow changes on the model state.
        abstract onModelChanged: sender: IOutputAreaModel * args: IOutputAreaModel.ChangedArgs -> unit
        /// Follow changes on the output model state.
        abstract onStateChanged: sender: IOutputAreaModel -> unit
        /// Handle an input request from a kernel.
        abstract onInputRequest: msg: KernelMessage.IInputRequestMsg * future: Kernel.IShellFuture -> unit
    ...
    module OutputArea =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract execute: code: string * output: OutputArea * session: IClientSession * ?metadata: JSONObject -> Promise<KernelMessage.IExecuteReplyMsg>
    ...
    module Stdin =
        ...
        type [<AllowNullLiteral>] IOptions =
            ...
            abstract future: Kernel.IShellFuture with get, set
