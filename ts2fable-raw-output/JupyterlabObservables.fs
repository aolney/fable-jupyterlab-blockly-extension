...
module Modeldb =
    ...
    type IObservableUndoableList = Undoablelist.IObservableUndoableList
    type IObservableMap = Observablemap.IObservableMap
...
module Observablejson =
    ...
    type IObservableMap = Observablemap.IObservableMap
    type ObservableMap = Observablemap.ObservableMap
...
module Undoablelist =
    type JSONValue = __@phosphor_coreutils.JSONValue
    type IObservableList = Observablelist.IObservableList
    type ObservableList = Observablelist.ObservableList
