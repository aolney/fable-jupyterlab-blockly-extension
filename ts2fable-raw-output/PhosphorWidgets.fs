...
type IObservableDisposable = ``@phosphor_disposable``.IObservableDisposable
type ConflatableMessage = ``@phosphor_messaging``.ConflatableMessage
type IMessageHandler = ``@phosphor_messaging``.IMessageHandler
...
type IIterable = ``@phosphor_algorithm``.IIterable
type IIterator = ``@phosphor_algorithm``.IIterator
...
module CommandPalette =
    ...
    type [<AllowNullLiteral>] IItem =
        ...
        abstract dataset: CommandRegistry.Dataset
        ...
        abstract keyBinding: CommandRegistry.IKeyBinding option
    ...
    type [<AllowNullLiteral>] Renderer =
        ...
        abstract formatHeader: data: IHeaderRenderData -> H.Child
        ...
        abstract formatEmptyMessage: data: IEmptyMessageRenderData -> H.Child
        ...
        abstract formatItemShortcut: data: IItemRenderData -> H.Child
        ...
        abstract formatItemLabel: data: IItemRenderData -> H.Child
        ...
        abstract formatItemCaption: data: IItemRenderData -> H.Child
...
module Menu =
    ...
    type [<AllowNullLiteral>] Renderer =
        ...
        /// <param name="data">- The data to use for the label content.</param>
        abstract formatLabel: data: IRenderData -> H.Child
        /// <summary>Create the render content for the shortcut node.</summary>
        /// <param name="data">- The data to use for the shortcut content.</param>
        abstract formatShortcut: data: IRenderData -> H.Child
...
type ISignal = ``@phosphor_signaling``.ISignal
type ElementDataset = ``@phosphor_virtualdom``.ElementDataset
type ElementInlineStyle = ``@phosphor_virtualdom``.ElementInlineStyle
type VirtualElement = ``@phosphor_virtualdom``.VirtualElement
type Title = __title.Title
type Widget = __widget.Widget
