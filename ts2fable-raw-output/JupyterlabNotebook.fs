...
module Actions =
    type IClientSession = __@jupyterlab_apputils.IClientSession
    type nbformat = __@jupyterlab_coreutils.nbformat
    type Cell = __@jupyterlab_cells.Cell
    ...
    module NotebookActions =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract changeCellType: notebook: Notebook * value: Nbformat.CellType -> unit
...
module Celllist =
    type IIterator = __@phosphor_algorithm.IIterator
    type IterableOrArrayLike = __@phosphor_algorithm.IterableOrArrayLike
    type ISignal = __@phosphor_signaling.ISignal
    type ICellModel = __@jupyterlab_cells.ICellModel
    type IObservableList = __@jupyterlab_observables.IObservableList
    type IObservableUndoableList = __@jupyterlab_observables.IObservableUndoableList
    ...
    type [<AllowNullLiteral>] CellList =
        ...
        abstract changed: ISignal<CellList, IObservableList.IChangedArgs<ICellModel>>
    ...
    type [<AllowNullLiteral>] CellListStatic =
        ...
        [<Emit "new $0($1...)">] abstract Create: modelDB: IModelDB * factory: NotebookModel.IContentFactory -> CellList

module Default_toolbar =
    type DocumentRegistry = __@jupyterlab_docregistry.DocumentRegistry
    type Widget = __@phosphor_widgets.Widget
    type ReactWidget = __@jupyterlab_apputils.ReactWidget
    ...
    module ToolbarItems =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract getDefaultItems: panel: NotebookPanel -> ResizeArray<DocumentRegistry.IToolbarItem>
...
module Model =
    type DocumentModel = __@jupyterlab_docregistry.DocumentModel
    type DocumentRegistry = __@jupyterlab_docregistry.DocumentRegistry
    type ICellModel = __@jupyterlab_cells.ICellModel
    type ICodeCellModel = __@jupyterlab_cells.ICodeCellModel
    type IRawCellModel = __@jupyterlab_cells.IRawCellModel
    type IMarkdownCellModel = __@jupyterlab_cells.IMarkdownCellModel
    type CodeCellModel = __@jupyterlab_cells.CodeCellModel
    type CellModel = __@jupyterlab_cells.CellModel
    type nbformat = __@jupyterlab_coreutils.nbformat
    type IObservableJSON = __@jupyterlab_observables.IObservableJSON
    type IObservableUndoableList = __@jupyterlab_observables.IObservableUndoableList
    type IModelDB = __@jupyterlab_observables.IModelDB
    ...
    type [<AllowNullLiteral>] INotebookModel =
        inherit DocumentRegistry.IModel
    ...
    type [<AllowNullLiteral>] NotebookModel =
        ...
        abstract toJSON: unit -> Nbformat.INotebookContent
        /// Deserialize the model from JSON.
        /// 
        /// #### Notes
        /// Should emit a [contentChanged] signal.
        abstract fromJSON: value: Nbformat.INotebookContent -> unit
    ...
    module NotebookModel =
        ...
        type [<AllowNullLiteral>] IContentFactory =
            ...
            abstract codeCellContentFactory: CodeCellModel.IContentFactory
            ...
            abstract createCell: ``type``: Nbformat.CellType * opts: CellModel.IOptions -> ICellModel
            /// <summary>Create a new code cell.</summary>
            /// <param name="options">- The options used to create the cell.</param>
            abstract createCodeCell: options: CodeCellModel.IOptions -> ICodeCellModel
            /// <summary>Create a new markdown cell.</summary>
            /// <param name="options">- The options used to create the cell.</param>
            abstract createMarkdownCell: options: CellModel.IOptions -> IMarkdownCellModel
            /// <summary>Create a new raw cell.</summary>
            /// <param name="options">- The options used to create the cell.</param>
            abstract createRawCell: options: CellModel.IOptions -> IRawCellModel
        ...
        module ContentFactory =
            ...
            type [<AllowNullLiteral>] IOptions =
                ...
                abstract codeCellContentFactory: CodeCellModel.IContentFactory option with get, set
...
module Modelfactory =
    ...
    type DocumentRegistry = __@jupyterlab_docregistry.DocumentRegistry
    type IModelDB = __@jupyterlab_observables.IModelDB
    type Contents = __@jupyterlab_services.Contents
    ...
    type [<AllowNullLiteral>] NotebookModelFactory =
        inherit DocumentRegistry.IModelFactory<INotebookModel>
        /// The content model factory used by the NotebookModelFactory.
        abstract contentFactory: NotebookModel.IContentFactory
        /// The name of the model.
        abstract name: string
        /// The content type of the file.
        abstract contentType: Contents.ContentType
        /// The format of the file.
        abstract fileFormat: Contents.FileFormat
    ...
    module NotebookModelFactory =
        ...
        type [<AllowNullLiteral>] IOptions =
            ...
            abstract contentFactory: NotebookModel.IContentFactory option with get, set

module Modestatus =
    type VDomRenderer = __@jupyterlab_apputils.VDomRenderer
    type VDomModel = __@jupyterlab_apputils.VDomModel
    type Notebook = _.Notebook
    type NotebookMode = _.NotebookMode
...
module Notebooktools =
    type JSONValue = __@phosphor_coreutils.JSONValue
    type ConflatableMessage = __@phosphor_messaging.ConflatableMessage
    type Message = __@phosphor_messaging.Message
    type Widget = __@phosphor_widgets.Widget
    type Cell = __@jupyterlab_cells.Cell
    type CodeEditor = __@jupyterlab_codeeditor.CodeEditor
    type JSONEditor = __@jupyterlab_codeeditor.JSONEditor
    type nbformat = __@jupyterlab_coreutils.nbformat
    type ObservableJSON = __@jupyterlab_observables.ObservableJSON
    type NotebookPanel = Panel.NotebookPanel
    ...
    module NotebookTools =
        ...
        type [<AllowNullLiteral>] Tool =
            ...
            /// #### Notes
            /// The default implementation is a no-op.
            abstract onActiveCellMetadataChanged: msg: ObservableJSON.ChangeMessage -> unit
            /// Handle a change to the metadata of the active cell.
            /// 
            /// #### Notes
            /// The default implementation is a no-op.
            abstract onActiveNotebookPanelMetadataChanged: msg: ObservableJSON.ChangeMessage -> unit
        ...
        module MetadataEditorTool =
            ...
            type [<AllowNullLiteral>] IOptions =
                ...
                abstract editorFactory: CodeEditor.Factory with get, set
        ...
        module KeySelector =
            ...
            type [<AllowNullLiteral>] IOptions =
                ...
                abstract validCellTypes: ResizeArray<Nbformat.CellType> option with get, set
...
module Panel =
    type Token = __@phosphor_coreutils.Token
    type Message = __@phosphor_messaging.Message
    type ISignal = __@phosphor_signaling.ISignal
    type IClientSession = __@jupyterlab_apputils.IClientSession
    type Printing = __@jupyterlab_apputils.Printing
    type DocumentWidget = __@jupyterlab_docregistry.DocumentWidget
    type DocumentRegistry = __@jupyterlab_docregistry.DocumentRegistry
    type INotebookModel = Model.INotebookModel
    type Notebook = Widget.Notebook
    ...
    type [<AllowNullLiteral>] NotebookPanel =
        inherit DocumentWidget<Notebook, INotebookModel>
        abstract _onSave: sender: DocumentRegistry.Context * state: DocumentRegistry.SaveState -> unit
    ...
    type [<AllowNullLiteral>] NotebookPanelStatic =
        ...
        [<Emit "new $0($1...)">] abstract Create: options: DocumentWidget.IOptions<Notebook, INotebookModel> -> NotebookPanel
    ...
    module NotebookPanel =
        ...
        type [<AllowNullLiteral>] IContentFactory =
            inherit Notebook.IContentFactory
            /// Create a new content area for the panel.
            abstract createNotebook: options: Notebook.IOptions -> Notebook

        /// The default implementation of an `IContentFactory`.
        type [<AllowNullLiteral>] ContentFactory =
            inherit Notebook.ContentFactory
...
module Tokens =
    type IWidgetTracker = __@jupyterlab_apputils.IWidgetTracker
    type Cell = __@jupyterlab_cells.Cell
    type Token = __@phosphor_coreutils.Token
    type ISignal = __@phosphor_signaling.ISignal
    type Widget = __@phosphor_widgets.Widget
    ...
    type [<AllowNullLiteral>] INotebookTracker =
        inherit IWidgetTracker<NotebookPanel>
...
module Tracker =
    type WidgetTracker = __@jupyterlab_apputils.WidgetTracker
    type Cell = __@jupyterlab_cells.Cell
    type ISignal = __@phosphor_signaling.ISignal
    type INotebookTracker = Tokens.INotebookTracker
    type NotebookPanel = Panel.NotebookPanel
    ...
    type [<AllowNullLiteral>] NotebookTracker =
        inherit WidgetTracker<NotebookPanel>
...
module Widget =
    ...
    type Widget = __@phosphor_widgets.Widget
    type Cell = __@jupyterlab_cells.Cell
    type CodeCell = __@jupyterlab_cells.CodeCell
    type MarkdownCell = __@jupyterlab_cells.MarkdownCell
    type RawCell = __@jupyterlab_cells.RawCell
    type IEditorMimeTypeService = __@jupyterlab_codeeditor.IEditorMimeTypeService
    type CodeEditor = __@jupyterlab_codeeditor.CodeEditor
    type IChangedArgs = __@jupyterlab_coreutils.IChangedArgs
    type nbformat = __@jupyterlab_coreutils.nbformat
    type IObservableMap = __@jupyterlab_observables.IObservableMap
    type IRenderMimeRegistry = __@jupyterlab_rendermime.IRenderMimeRegistry
    type INotebookModel = Model.INotebookModel

    type [<AllowNullLiteral>] IExports =
        abstract Notebook: StaticNotebookStatic
    ...
    type [<AllowNullLiteral>] StaticNotebook =
        ...
        abstract onMetadataChanged: sender: IObservableMap<JSONValue> * args: IObservableMap.IChangedArgs<JSONValue> -> unit
    ...
    module StaticNotebook =
        ...
        type [<AllowNullLiteral>] IContentFactory =
            inherit Cell.IContentFactory
            /// Create a new code cell widget.
            abstract createCodeCell: options: CodeCell.IOptions * parent: StaticNotebook -> CodeCell
            /// Create a new markdown cell widget.
            abstract createMarkdownCell: options: MarkdownCell.IOptions * parent: StaticNotebook -> MarkdownCell
            /// Create a new raw cell widget.
            abstract createRawCell: options: RawCell.IOptions * parent: StaticNotebook -> RawCell
        ...
        type [<AllowNullLiteral>] INotebookConfig =
            ...
            abstract defaultCell: Nbformat.CellType with get, set

        /// The default implementation of an `IContentFactory`.
        /// A namespace for the staic notebook content factory.
        type [<AllowNullLiteral>] ContentFactory =
            inherit Cell.ContentFactory
            inherit IContentFactory
            /// Create a new code cell widget.
            /// 
            /// #### Notes
        ...
        module ContentFactory =
            ...
            type [<AllowNullLiteral>] IOptions =
                inherit Cell.ContentFactory.IOptions
...
module Widgetfactory =
    type IEditorMimeTypeService = __@jupyterlab_codeeditor.IEditorMimeTypeService
    type ABCWidgetFactory = __@jupyterlab_docregistry.ABCWidgetFactory
    type DocumentRegistry = __@jupyterlab_docregistry.DocumentRegistry
    type IRenderMimeRegistry = __@jupyterlab_rendermime.IRenderMimeRegistry
    type INotebookModel = Model.INotebookModel
    type NotebookPanel = Panel.NotebookPanel
    ...
    type [<AllowNullLiteral>] NotebookWidgetFactory =
        inherit ABCWidgetFactory<NotebookPanel, INotebookModel>
        abstract rendermime: IRenderMimeRegistry
        /// The content factory used by the widget factory.
        abstract contentFactory: NotebookPanel.IContentFactory
        /// The service used to look up mime types.
        ...
        abstract createNewWidget: context: DocumentRegistry.IContext<INotebookModel> * ?source: NotebookPanel -> NotebookPanel
        /// Default factory for toolbar items to be added after the widget is created.
        abstract defaultToolbarFactory: widget: NotebookPanel -> ResizeArray<DocumentRegistry.IToolbarItem>
    ...
    module NotebookWidgetFactory =
        ...
        type [<AllowNullLiteral>] IOptions<'T> =
            inherit DocumentRegistry.IWidgetFactoryOptions<'T>
            abstract rendermime: IRenderMimeRegistry with get, set
            /// A notebook panel content factory.
            abstract contentFactory: NotebookPanel.IContentFactory with get, set
            /// The service used to look up mime types.
            abstract mimeTypeService: IEditorMimeTypeService with get, set
            /// The notebook cell editor configuration.
            abstract editorConfig: StaticNotebook.IEditorConfig option with get, set
            /// The notebook configuration.
            abstract notebookConfig: StaticNotebook.INotebookConfig option with get, set
