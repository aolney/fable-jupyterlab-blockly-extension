...
module Manager =
    type Poll = __@jupyterlab_coreutils.Poll
    type IDisposable = __@phosphor_disposable.IDisposable
    type ISignal = __@phosphor_signaling.ISignal
    type Builder = Builder.Builder
    type BuildManager = Builder.BuildManager
    type NbConvert = Nbconvert.NbConvert
    type NbConvertManager = Nbconvert.NbConvertManager
    type Contents = Contents.Contents
    type ContentsManager = Contents.ContentsManager
    type Kernel = Kernel.Kernel
    type Session = Session.Session
    type SessionManager = Session.SessionManager
    type Setting = Setting.Setting
    type SettingManager = Setting.SettingManager
    ...
    type [<AllowNullLiteral>] ServiceManager =
        ...
        abstract specsChanged: ISignal<ServiceManager, Kernel.ISpecModels>
        ...
        abstract specs: Kernel.ISpecModels option
        /// The server settings of the manager.
        abstract serverSettings: ServerConnection.ISettings
        /// Get the session manager instance.
        abstract sessions: SessionManager
        ...
        abstract terminals: TerminalManager
    ...
    module ServiceManager =
        ...
        type [<AllowNullLiteral>] IManager =
            inherit IDisposable
            /// The builder for the manager.
            abstract builder: Builder.IManager
            /// The contents manager for the manager.
            abstract contents: Contents.IManager
            /// Test whether the manager is ready.
            abstract isReady: bool
            ...
            abstract sessions: Session.IManager
            /// The setting manager for the manager.
            abstract settings: Setting.IManager
            /// The kernel spec models.
            abstract specs: Kernel.ISpecModels option
            /// A signal emitted when the kernel specs change.
            abstract specsChanged: ISignal<IManager, Kernel.ISpecModels>
            /// The terminals manager for the manager.
            abstract terminals: TerminalSession.IManager
            /// The workspace manager for the manager.
            abstract workspaces: Workspace.IManager
            /// The nbconvert manager for the manager.
            abstract nbconvert: NbConvert.IManager
        ...
        type [<AllowNullLiteral>] IOptions =
            /// The server settings of the manager.
            abstract serverSettings: ServerConnection.ISettings option
            /// The default drive for the contents manager.
            abstract defaultDrive: Contents.IDrive option
            /// When the manager stops polling the API. Defaults to `when-hidden`.
            abstract standby: Poll.Standby option with get, set
...
module Serverconnection =
    ...
    module ServerConnection =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract defaultSettings: ServerConnection.ISettings
...
module __builder_index =
    ...
    module BuildManager =
        ...
        type [<AllowNullLiteral>] IOptions =
            /// The server settings used to make API requests.
            abstract serverSettings: ServerConnection.ISettings option with get, set
...
module __config_index =
    type JSONObject = __config_@phosphor_coreutils.JSONObject
    type JSONValue = __config_@phosphor_coreutils.JSONValue
...
module __contents_index =
    type ModelDB = __contents_@jupyterlab_observables.ModelDB
    type IDisposable = __contents_@phosphor_disposable.IDisposable
    type ISignal = __contents_@phosphor_signaling.ISignal
    type ServerConnection = __.ServerConnection
    ...
    module Contents =
        ...
        type [<AllowNullLiteral>] IManager =
            ...
            abstract getModelDBFactory: path: string -> ModelDB.IFactory option
        ...
        type [<AllowNullLiteral>] IDrive =
            ...
            /// drive.
            abstract modelDBFactory: ModelDB.IFactory option
            /// A signal emitted when a file operation takes place.
...
module __contents_validate =
    ...
    type [<AllowNullLiteral>] IExports =
        ...
        abstract validateContentsModel: model: Contents.IModel -> unit
        /// Validate an `Contents.ICheckpointModel` object.
        abstract validateCheckpointModel: model: Contents.ICheckpointModel -> unit

module __kernel_comm =
    type JSONObject = __kernel_@phosphor_coreutils.JSONObject
    type DisposableDelegate = __kernel_@phosphor_disposable.DisposableDelegate
    ...
    type [<AllowNullLiteral>] CommHandler =
        ...
        /// 
        /// **See also:** [[close]]
        abstract onClose: (KernelMessage.ICommCloseMsg -> U2<unit, PromiseLike<unit>>) with get, set
        ...
        abstract onMsg: (KernelMessage.ICommMsgMsg -> U2<unit, PromiseLike<unit>>) with get, set
        ...
        /// 
        /// **See also:** [[ICommOpen]]
        abstract ``open``: ?data: JSONObject * ?metadata: JSONObject * ?buffers: ResizeArray<U2<ArrayBuffer, ArrayBufferView>> -> Kernel.IShellFuture
        ...
        /// 
        /// **See also:** [[ICommMsg]]
        abstract send: data: JSONObject * ?metadata: JSONObject * ?buffers: ResizeArray<U2<ArrayBuffer, ArrayBufferView>> * ?disposeOnDone: bool -> Kernel.IShellFuture
        /// Close the comm.
        /// 
        /// #### Notes
        ...
        abstract close: ?data: JSONObject * ?metadata: JSONObject * ?buffers: ResizeArray<U2<ArrayBuffer, ArrayBufferView>> -> Kernel.IShellFuture

    /// Comm channel handler.
    type [<AllowNullLiteral>] CommHandlerStatic =
        /// Construct a new comm channel.
        [<Emit "new $0($1...)">] abstract Create: target: string * id: string * kernel: Kernel.IKernel * disposeCb: (unit -> unit) -> CommHandler

module __kernel_default =
    type JSONObject = __kernel_@phosphor_coreutils.JSONObject
    type ISignal = __kernel_@phosphor_signaling.ISignal
    type ServerConnection = __.ServerConnection
    type Kernel = __kernel_kernel.Kernel
    type KernelMessage = __kernel_messages.KernelMessage
    ...
    type [<AllowNullLiteral>] DefaultKernel =
        ...
        abstract statusChanged: ISignal<DefaultKernel, Kernel.Status>
        /// A signal emitted for iopub kernel messages.
        /// 
        /// #### Notes
        /// This signal is emitted after the iopub message is handled asynchronously.
        abstract iopubMessage: ISignal<DefaultKernel, KernelMessage.IIOPubMessage>
        /// A signal emitted for unhandled kernel message.
        /// 
        /// #### Notes
        /// This signal is emitted for a message that was not handled. It is emitted
        /// during the asynchronous message handling code.
        abstract unhandledMessage: ISignal<DefaultKernel, KernelMessage.IMessage>
        ...
        abstract anyMessage: ISignal<DefaultKernel, Kernel.IAnyMessageArgs>
        /// The id of the server-side kernel.
        abstract id: string
        /// The name of the server-side kernel.
        abstract name: string
        /// Get the model associated with the kernel.
        abstract model: Kernel.IModel
        /// The client username.
        abstract username: string
        /// The client unique id.
        abstract clientId: string
        /// The current status of the kernel.
        abstract status: Kernel.Status
        ...
        abstract info: KernelMessage.IInfoReply option
        /// Test whether the kernel is ready.
        abstract isReady: bool
        /// A promise that is fulfilled when the kernel is ready.
        abstract ready: Promise<unit>
        /// Get the kernel spec.
        abstract getSpec: unit -> Promise<Kernel.ISpecModel>
        /// Clone the current kernel with a new clientId.
        abstract clone: ?options: Kernel.IOptions -> Kernel.IKernel
        ...
        abstract sendShellMessage: msg: KernelMessage.IShellMessage<'T> * ?expectReply: bool * ?disposeOnDone: bool -> Kernel.IShellFuture<KernelMessage.IShellMessage<'T>>
        ...
        /// 
        /// If the kernel status is `dead`, this will throw an error.
        abstract sendControlMessage: msg: KernelMessage.IControlMessage<'T> * ?expectReply: bool * ?disposeOnDone: bool -> Kernel.IControlFuture<KernelMessage.IControlMessage<'T>>
        /// Interrupt a kernel.
        /// 
        /// #### Notes
        ...
        abstract requestKernelInfo: unit -> Promise<KernelMessage.IInfoReplyMsg>
        ...
        /// received and validated.
        abstract requestComplete: content: KernelMessage.ICompleteRequestMsg -> Promise<KernelMessage.ICompleteReplyMsg>
        ...
        /// received and validated.
        abstract requestInspect: content: KernelMessage.IInspectRequestMsg -> Promise<KernelMessage.IInspectReplyMsg>
        ...
        /// received and validated.
        abstract requestHistory: content: KernelMessage.IHistoryRequestMsg -> Promise<KernelMessage.IHistoryReplyMsg>
        ...
        abstract requestExecute: content: KernelMessage.IExecuteRequestMsg * ?disposeOnDone: bool * ?metadata: JSONObject -> Kernel.IShellFuture<KernelMessage.IExecuteRequestMsg, KernelMessage.IExecuteReplyMsg>
        /// Send an experimental `debug_request` message.
        abstract requestDebug: content: KernelMessage.IDebugRequestMsg * ?disposeOnDone: bool -> Kernel.IControlFuture<KernelMessage.IDebugRequestMsg, KernelMessage.IDebugReplyMsg>
        ...
        /// received and validated.
        abstract requestIsComplete: content: KernelMessage.IIsCompleteRequestMsg -> Promise<KernelMessage.IIsCompleteReplyMsg>
        /// Send a `comm_info_request` message.
        /// 
        /// #### Notes
        /// Fulfills with the `comm_info_reply` content when the shell reply is
        /// received and validated.
        abstract requestCommInfo: content: KernelMessage.ICommInfoRequestMsg -> Promise<KernelMessage.ICommInfoReplyMsg>
        /// Send an `input_reply` message.
        /// 
        /// #### Notes
        /// See [Messaging in Jupyter](https://jupyter-client.readthedocs.io/en/latest/messaging.html#messages-on-the-stdin-router-dealer-sockets).
        abstract sendInputReply: content: KernelMessage.IInputReplyMsg -> unit
        ...
        abstract registerCommTarget: targetName: string * callback: (Kernel.IComm -> KernelMessage.ICommOpenMsg -> U2<unit, PromiseLike<unit>>) -> unit
        ...
        abstract removeCommTarget: targetName: string * callback: (Kernel.IComm -> KernelMessage.ICommOpenMsg -> U2<unit, PromiseLike<unit>>) -> unit
        ...
        abstract registerMessageHook: msgId: string * hook: (KernelMessage.IIOPubMessage -> U2<bool, PromiseLike<bool>>) -> unit
        /// <summary>Remove an IOPub message hook.</summary>
        /// <param name="hook">- The callback invoked for the message.</param>
        abstract removeMessageHook: msgId: string * hook: (KernelMessage.IIOPubMessage -> U2<bool, PromiseLike<bool>>) -> unit
    ...
    type [<AllowNullLiteral>] DefaultKernelStatic =
        ...
        [<Emit "new $0($1...)">] abstract Create: options: Kernel.IOptions * id: string -> DefaultKernel
    ...
    module DefaultKernel =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract findById: id: string * ?settings: ServerConnection.ISettings -> Promise<Kernel.IModel>
            /// <summary>Fetch all of the kernel specs.</summary>
            /// <param name="settings">- The optional server settings.</param>
            abstract getSpecs: ?settings: ServerConnection.ISettings -> Promise<Kernel.ISpecModels>
            /// <summary>Fetch the running kernels.</summary>
            /// <param name="settings">- The optional server settings.</param>
            abstract listRunning: ?settings: ServerConnection.ISettings -> Promise<ResizeArray<Kernel.IModel>>
            /// <summary>Start a new kernel.</summary>
            /// <param name="options">- The options used to create the kernel.</param>
            abstract startNew: options: Kernel.IOptions -> Promise<Kernel.IKernel>
            ...
            abstract connectTo: model: Kernel.IModel * ?settings: ServerConnection.ISettings -> Kernel.IKernel
            /// <summary>Shut down a kernel by id.</summary>
            /// <param name="id">- The id of the running kernel.</param>
            /// <param name="settings">- The server settings for the request.</param>
            abstract shutdown: id: string * ?settings: ServerConnection.ISettings -> Promise<unit>
            /// <summary>Shut down all kernels.</summary>
            /// <param name="settings">- The server settings to use.</param>
            abstract shutdownAll: ?settings: ServerConnection.ISettings -> Promise<unit>
...
module __kernel_future =
    ...
    type [<AllowNullLiteral>] KernelFutureHandler<'REQUEST, 'REPLY> =
        inherit DisposableDelegate
        inherit Kernel.IFuture<'REQUEST, 'REPLY>
        ...
        abstract onIOPub: (KernelMessage.IIOPubMessage -> U2<unit, PromiseLike<unit>>) with get, set
        /// Get the stdin handler.
        /// Set the stdin handler.
        abstract onStdin: (KernelMessage.IStdinMessage -> U2<unit, PromiseLike<unit>>) with get, set
        ...
        abstract registerMessageHook: hook: (KernelMessage.IIOPubMessage -> U2<bool, PromiseLike<bool>>) -> unit
        ...
        abstract removeMessageHook: hook: (KernelMessage.IIOPubMessage -> U2<bool, PromiseLike<bool>>) -> unit
        /// Send an `input_reply` message.
        abstract sendInputReply: content: KernelMessage.IInputReplyMsg -> unit
        /// Dispose and unregister the future.
        abstract dispose: unit -> unit
        /// Handle an incoming kernel message.
        abstract handleMsg: msg: KernelMessage.IMessage -> Promise<unit>
    ...
    type [<AllowNullLiteral>] KernelFutureHandlerStatic =
        ...
        [<Emit "new $0($1...)">] abstract Create: cb: (unit -> unit) * msg: 'REQUEST * expectReply: bool * disposeOnDone: bool * kernel: Kernel.IKernel -> KernelFutureHandler<'REQUEST, 'REPLY>
    ...
    type [<AllowNullLiteral>] KernelControlFutureHandler<'REQUEST, 'REPLY> =
        ...
        inherit Kernel.IControlFuture<'REQUEST, 'REPLY>
    ...
    type [<AllowNullLiteral>] KernelShellFutureHandler<'REQUEST, 'REPLY> =
        inherit KernelFutureHandler<'REQUEST, 'REPLY>
        inherit Kernel.IShellFuture<'REQUEST, 'REPLY>
...
module __kernel_kernel =
    type IIterator = __kernel_@phosphor_algorithm.IIterator
    type JSONObject = __kernel_@phosphor_coreutils.JSONObject
    type JSONValue = __kernel_@phosphor_coreutils.JSONValue
    type IDisposable = __kernel_@phosphor_disposable.IDisposable
    type ISignal = __kernel_@phosphor_signaling.ISignal
    type ServerConnection = __.ServerConnection
    type KernelMessage = __kernel_messages.KernelMessage
    ...
    module Kernel =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            /// <param name="id">- The id of the kernel of interest.</param>
            /// <param name="settings">- The optional server settings.</param>
            abstract findById: id: string * ?settings: ServerConnection.ISettings -> Promise<IModel>
            /// <summary>Fetch all of the kernel specs.</summary>
            /// <param name="settings">- The optional server settings.</param>
            abstract getSpecs: ?settings: ServerConnection.ISettings -> Promise<Kernel.ISpecModels>
            /// <summary>Fetch the running kernels.</summary>
            ...
            /// <summary>Start a new kernel.</summary>
            /// <param name="options">- The options used to create the kernel.</param>
            abstract startNew: ?options: Kernel.IOptions -> Promise<IKernel>
            /// <summary>Connect to a running kernel.</summary>
            /// <param name="model">- The model of the running kernel.</param>
            /// <param name="settings">- The server settings for the request.</param>
            abstract connectTo: model: Kernel.IModel * ?settings: ServerConnection.ISettings -> IKernel
            /// <summary>Shut down a kernel by id.</summary>
            /// <param name="id">- The id of the running kernel.</param>
            /// <param name="settings">- The server settings for the request.</param>
            abstract shutdown: id: string * ?settings: ServerConnection.ISettings -> Promise<unit>
        ...
        type [<AllowNullLiteral>] IKernel =
            ...
            /// A signal emitted when the kernel status changes.
            abstract statusChanged: ISignal<IKernel, Kernel.Status> with get, set
            /// A signal emitted after an iopub kernel message is handled.
            abstract iopubMessage: ISignal<IKernel, KernelMessage.IIOPubMessage> with get, set
            ...
            abstract unhandledMessage: ISignal<IKernel, KernelMessage.IMessage> with get, set
        ...
        type [<AllowNullLiteral>] IManager =
            ...
            abstract connectionFailure: ISignal<IManager, ServerConnection.NetworkError> with get, set
            ...
            abstract connectTo: model: Kernel.IModel -> IKernel
            /// <summary>Shut down a kernel by id.</summary>
            /// <param name="id">- The id of the target kernel.</param>
...
module __kernel_manager =
    type Poll = __kernel_@jupyterlab_coreutils.Poll
    type IIterator = __kernel_@phosphor_algorithm.IIterator
    type ISignal = __kernel_@phosphor_signaling.ISignal
    type ServerConnection = __.ServerConnection
    type Kernel = __kernel_kernel.Kernel
    ...
    type [<AllowNullLiteral>] KernelManager =
        ...
        abstract ready: Promise<unit>
        /// A signal emitted when the running kernels change.
        abstract runningChanged: ISignal<KernelManager, ResizeArray<Kernel.IModel>>
        /// Get the most recently fetched kernel specs.
        abstract specs: Kernel.ISpecModels option
        /// A signal emitted when the specs change.
        abstract specsChanged: ISignal<KernelManager, Kernel.ISpecModels>
        /// A signal emitted when there is a connection failure.
        abstract connectionFailure: ISignal<KernelManager, Error>
        /// <summary>Connect to an existing kernel.</summary>
        /// <param name="model">- The model of the target kernel.</param>
        abstract connectTo: model: Kernel.IModel -> Kernel.IKernel
        /// Dispose of the resources used by the manager.
        abstract dispose: unit -> unit
        /// <summary>Find a kernel by id.</summary>
        /// <param name="id">- The id of the target kernel.</param>
        abstract findById: id: string -> Promise<Kernel.IModel>
        /// Force a refresh of the running kernels.
        abstract refreshRunning: unit -> Promise<unit>
        /// Force a refresh of the specs from the server.
        abstract refreshSpecs: unit -> Promise<unit>
        /// Create an iterator over the most recent running kernels.
        abstract running: unit -> IIterator<Kernel.IModel>
        /// <summary>Shut down a kernel by id.</summary>
        /// <param name="id">- The id of the target kernel.</param>
        abstract shutdown: id: string -> Promise<unit>
        /// Shut down all kernels.
...
module __kernel_messages =
    type nbformat = __kernel_@jupyterlab_coreutils.nbformat
    type JSONObject = __kernel_@phosphor_coreutils.JSONObject
    type Kernel = __kernel_kernel.Kernel
    ...
    module KernelMessage =
        ...
        type [<AllowNullLiteral>] ILanguageInfo =
            inherit Nbformat.ILanguageInfoMetadata
            abstract version: string with get, set
        ...
        type [<AllowNullLiteral>] IExecuteCount =
            abstract execution_count: Nbformat.ExecutionCount with get, set
        ...
        type [<AllowNullLiteral>] TypeLiteral_04 =
            abstract data: Nbformat.IMimeBundle with get, set
            abstract metadata: Nbformat.OutputMetadata with get, set
        ...
        type [<AllowNullLiteral>] TypeLiteral_08 =
            abstract execution_state: Kernel.Status with get, set
...
module __kernel_serialize =
    ...
    type [<AllowNullLiteral>] IExports =
        ...
        abstract deserialize: data: U2<ArrayBuffer, string> -> KernelMessage.IMessage
        /// Serialize a kernel message for transport.
        /// 
        /// #### Notes
        /// If there is binary content, an `ArrayBuffer` is returned,
        /// otherwise the message is converted to a JSON string.
        abstract serialize: msg: KernelMessage.IMessage -> U2<string, ArrayBuffer>
...
module __kernel_validate =
    ...
    type [<AllowNullLiteral>] IExports =
        ...
        abstract validateMessage: msg: KernelMessage.IMessage -> unit
        /// Validate a `Kernel.IModel` object.
        abstract validateModel: model: Kernel.IModel -> unit
        /// Validate a server kernelspec model to a client side model.
        abstract validateSpecModel: data: obj option -> Kernel.ISpecModel
        /// Validate a `Kernel.ISpecModels` object.
        abstract validateSpecModels: data: obj option -> Kernel.ISpecModels
...
module __session_default =
    type ISignal = __session_@phosphor_signaling.ISignal
    type Kernel = Kernel.Kernel
    type KernelMessage = Kernel.KernelMessage
    type ServerConnection = __.ServerConnection
    ...
    type [<AllowNullLiteral>] DefaultSession =
        inherit Session.ISession
        /// A signal emitted when the session is shut down.
        abstract terminated: ISignal<DefaultSession, unit>
        /// A signal emitted when the kernel changes.
        abstract kernelChanged: ISignal<DefaultSession, Session.IKernelChangedArgs>
        /// A signal emitted when the kernel status changes.
        abstract statusChanged: ISignal<DefaultSession, Kernel.Status>
        /// A signal emitted for a kernel messages.
        abstract iopubMessage: ISignal<DefaultSession, KernelMessage.IIOPubMessage>
        /// A signal emitted for an unhandled kernel message.
        abstract unhandledMessage: ISignal<DefaultSession, KernelMessage.IMessage>
        /// A signal emitted for any kernel message.
        /// 
        ...
        abstract anyMessage: ISignal<DefaultSession, Kernel.IAnyMessageArgs>
        ...
        abstract kernel: Kernel.IKernelConnection
        ...
        abstract clone: unit -> Session.ISession
        /// Update the session based on a session model from the server.
        abstract update: model: Session.IModel -> unit
        ...
        /// Change the kernel.
        abstract changeKernel: options: obj -> Promise<Kernel.IKernelConnection>
        ...
        abstract setupKernel: model: Kernel.IModel -> unit
        /// Handle to changes in the Kernel status.
        abstract onKernelStatus: sender: Kernel.IKernel * state: Kernel.Status -> unit
        /// Handle iopub kernel messages.
        abstract onIOPubMessage: sender: Kernel.IKernel * msg: KernelMessage.IIOPubMessage -> unit
        /// Handle unhandled kernel messages.
        abstract onUnhandledMessage: sender: Kernel.IKernel * msg: KernelMessage.IMessage -> unit
        /// Handle any kernel messages.
        abstract onAnyMessage: sender: Kernel.IKernel * args: Kernel.IAnyMessageArgs -> unit
    ...
    type [<AllowNullLiteral>] DefaultSessionStatic =
        ...
        [<Emit "new $0($1...)">] abstract Create: options: Session.IOptions * id: string * model: Kernel.IModel -> DefaultSession

    module DefaultSession =

        type [<AllowNullLiteral>] IExports =
            /// List the running sessions.
            abstract listRunning: ?settings: ServerConnection.ISettings -> Promise<ResizeArray<Session.IModel>>
            /// Start a new session.
            abstract startNew: options: Session.IOptions -> Promise<Session.ISession>
            /// Find a session by id.
            abstract findById: id: string * ?settings: ServerConnection.ISettings -> Promise<Session.IModel>
            /// Find a session by path.
            abstract findByPath: path: string * ?settings: ServerConnection.ISettings -> Promise<Session.IModel>
            /// Connect to a running session.
            abstract connectTo: model: Session.IModel * ?settings: ServerConnection.ISettings -> Session.ISession
...
module __session_manager =
    type Poll = __session_@jupyterlab_coreutils.Poll
    type IIterator = __session_@phosphor_algorithm.IIterator
    type ISignal = __session_@phosphor_signaling.ISignal
    type Kernel = Kernel.Kernel
    type ServerConnection = Serverconnection.ServerConnection
    type Session = __session_session.Session
    ...
    type [<AllowNullLiteral>] SessionManager =
        inherit Session.IManager
        /// A signal emitted when the kernel specs change.
        abstract specsChanged: ISignal<SessionManager, Kernel.ISpecModels>
        /// A signal emitted when the running sessions change.
        abstract runningChanged: ISignal<SessionManager, ResizeArray<Session.IModel>>
        /// A signal emitted when there is a connection failure.
        ...
        abstract running: unit -> IIterator<Session.IModel>
        /// Force a refresh of the specs from the server.
        abstract refreshSpecs: unit -> Promise<unit>
        ...
        /// Find a session by id.
        abstract findById: id: string -> Promise<Session.IModel>
        /// Find a session by path.
        abstract findByPath: path: string -> Promise<Session.IModel>
        abstract connectTo: model: Session.IModel -> Session.ISession
        /// Shut down a session by id.
        abstract shutdown: id: string -> Promise<unit>
...
module __session_session =
    type IIterator = __session_@phosphor_algorithm.IIterator
    type JSONObject = __session_@phosphor_coreutils.JSONObject
    type IDisposable = __session_@phosphor_disposable.IDisposable
    type ISignal = __session_@phosphor_signaling.ISignal
    type Kernel = Kernel.Kernel
    type KernelMessage = Kernel.KernelMessage
    type ServerConnection = __.ServerConnection
    ...
    module Session =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract connectTo: model: Session.IModel * ?settings: ServerConnection.ISettings -> ISession
        ...
        type [<AllowNullLiteral>] ISession =
            ...
            abstract statusChanged: ISignal<ISession, Kernel.Status> with get, set
            /// A signal emitted when a session property changes.
            abstract propertyChanged: ISignal<ISession, U3<string, string, string>>
            /// A signal emitted for iopub kernel messages.
            abstract iopubMessage: ISignal<ISession, KernelMessage.IIOPubMessage> with get, set
            /// A signal emitted for unhandled kernel message.
            abstract unhandledMessage: ISignal<ISession, KernelMessage.IMessage> with get, set
            /// A signal emitted for any kernel message.
            /// 
            /// Note: The behavior is undefined if the message is modified
            /// during message handling. As such, it should be treated as read-only.
            abstract anyMessage: ISignal<ISession, Kernel.IAnyMessageArgs> with get, set
        ...
        type [<AllowNullLiteral>] IKernelChangedArgs =
            /// The old kernel.
            abstract oldValue: Kernel.IKernelConnection option with get, set
            /// The new kernel.
            abstract newValue: Kernel.IKernelConnection option with get, set
        ...
        type [<AllowNullLiteral>] IManager =
            inherit IDisposable
            /// A signal emitted when the kernel specs change.
            abstract specsChanged: ISignal<IManager, Kernel.ISpecModels> with get, set
            /// A signal emitted when the running sessions change.
            abstract runningChanged: ISignal<IManager, ResizeArray<IModel>> with get, set
            /// A signal emitted when there is a connection failure.
            abstract connectionFailure: ISignal<IManager, ServerConnection.NetworkError> with get, set
...
module __session_validate =
    ...
    type [<AllowNullLiteral>] IExports =
        ...
        abstract validateModel: data: obj option -> Session.IModel

module __setting_index =
    type DataConnector = __setting_@jupyterlab_coreutils.DataConnector
    type ISettingRegistry = __setting_@jupyterlab_coreutils.ISettingRegistry
    type ServerConnection = Serverconnection.ServerConnection
    ...
    type [<AllowNullLiteral>] SettingManager =
        inherit DataConnector<ISettingRegistry.IPlugin, string>
        /// The server settings used to make API requests.
        abstract serverSettings: ServerConnection.ISettings
        /// <summary>Fetch a plugin's settings.</summary>
        /// <param name="id">- The plugin's ID.</param>
        abstract fetch: id: string -> Promise<ISettingRegistry.IPlugin>
    ...
    type [<AllowNullLiteral>] TypeLiteral_01 =
        ...
        abstract values: ResizeArray<ISettingRegistry.IPlugin> with get, set

module __terminal_default =
    type ISignal = __terminal_@phosphor_signaling.ISignal
    type Signal = __terminal_@phosphor_signaling.Signal
    type ServerConnection = __.ServerConnection
    ...
    type [<AllowNullLiteral>] DefaultTerminalSession =
        inherit TerminalSession.ISession
        /// A signal emitted when the session is shut down.
        abstract terminated: Signal<DefaultTerminalSession, unit>
        /// A signal emitted when a message is received from the server.
        abstract messageReceived: ISignal<DefaultTerminalSession, TerminalSession.IMessage>
        /// Get the name of the terminal session.
        abstract name: string
        /// Get the model for the terminal session.
        abstract model: TerminalSession.IModel
        ...
        abstract send: message: TerminalSession.IMessage -> unit
        /// Reconnect to the terminal.
        abstract reconnect: unit -> Promise<unit>
        /// Shut down the terminal session.
        abstract shutdown: unit -> Promise<unit>
        /// Clone the current session object.
        abstract clone: unit -> TerminalSession.ISession

    /// An implementation of a terminal interface.
    /// The static namespace for `DefaultTerminalSession`.
    type [<AllowNullLiteral>] DefaultTerminalSessionStatic =
        /// Construct a new terminal session.
        [<Emit "new $0($1...)">] abstract Create: name: string * ?options: TerminalSession.IOptions -> DefaultTerminalSession
    ...
    module DefaultTerminalSession =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            /// <param name="options">- The session options to use.</param>
            abstract startNew: ?options: TerminalSession.IOptions -> Promise<TerminalSession.ISession>
            abstract connectTo: name: string * ?options: TerminalSession.IOptions -> Promise<TerminalSession.ISession>
            /// <summary>List the running terminal sessions.</summary>
            /// <param name="settings">- The server settings to use.</param>
            abstract listRunning: ?settings: ServerConnection.ISettings -> Promise<ResizeArray<TerminalSession.IModel>>
            /// <summary>Shut down a terminal session by name.</summary>
            /// <param name="name">- The name of the target session.</param>
            /// <param name="settings">- The server settings to use.</param>
            abstract shutdown: name: string * ?settings: ServerConnection.ISettings -> Promise<unit>
            /// <summary>Shut down all terminal sessions.</summary>
            /// <param name="settings">- The server settings to use.</param>
            abstract shutdownAll: ?settings: ServerConnection.ISettings -> Promise<unit>

module __terminal_manager =
    type Poll = __terminal_@jupyterlab_coreutils.Poll
    type IIterator = __terminal_@phosphor_algorithm.IIterator
    type ISignal = __terminal_@phosphor_signaling.ISignal
    type ServerConnection = __.ServerConnection
    type TerminalSession = __terminal_terminal.TerminalSession
    ...
    type [<AllowNullLiteral>] TerminalManager =
        inherit TerminalSession.IManager
        /// A signal emitted when the running terminals change.
        abstract runningChanged: ISignal<TerminalManager, ResizeArray<TerminalSession.IModel>>
        /// A signal emitted when there is a connection failure.
        ...
        abstract running: unit -> IIterator<TerminalSession.IModel>
...
module __terminal_terminal =
    type IIterator = __terminal_@phosphor_algorithm.IIterator
    type JSONPrimitive = __terminal_@phosphor_coreutils.JSONPrimitive
    type JSONObject = __terminal_@phosphor_coreutils.JSONObject
    type IDisposable = __terminal_@phosphor_disposable.IDisposable
    type ISignal = __terminal_@phosphor_signaling.ISignal
    type ServerConnection = __.ServerConnection
    ...
    module TerminalSession =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            /// <summary>List the running terminal sessions.</summary>
            /// <param name="settings">- The server settings to use.</param>
            abstract listRunning: ?settings: ServerConnection.ISettings -> Promise<ResizeArray<IModel>>
            /// <summary>Shut down a terminal session by name.</summary>
            /// <param name="name">- The name of the target session.</param>
            /// <param name="settings">- The server settings to use.</param>
            abstract shutdown: name: string * ?settings: ServerConnection.ISettings -> Promise<unit>
...
module __workspace_index =
    type DataConnector = __workspace_@jupyterlab_coreutils.DataConnector
    type ReadonlyJSONObject = __workspace_@phosphor_coreutils.ReadonlyJSONObject
    type ServerConnection = Serverconnection.ServerConnection
