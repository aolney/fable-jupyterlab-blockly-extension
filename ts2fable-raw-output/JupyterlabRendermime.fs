...
module Attachmentmodel =
    ...
    type JSONObject = __@phosphor_coreutils.JSONObject
    type ReadonlyJSONObject = __@phosphor_coreutils.ReadonlyJSONObject
    ...
    type [<AllowNullLiteral>] IAttachmentModel =
        inherit IRenderMime.IMimeModel
        ...
        abstract toJSON: unit -> Nbformat.IMimeBundle
    ...
    module IAttachmentModel =
        ...
        type [<AllowNullLiteral>] IOptions =
            ...
            abstract value: Nbformat.IMimeBundle with get, set
    ...
    type [<AllowNullLiteral>] AttachmentModel =
        ...
        abstract setData: options: IRenderMime.IMimeModel.ISetDataOptions -> unit
        /// Serialize the model to JSON.
        abstract toJSON: unit -> Nbformat.IMimeBundle
    ...
    module AttachmentModel =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract getData: bundle: Nbformat.IMimeBundle -> JSONObject

module Factories =
    type IRenderMime = __@jupyterlab_rendermime_interfaces.IRenderMime

    type [<AllowNullLiteral>] IExports =
        abstract htmlRendererFactory: IRenderMime.IRendererFactory
        abstract imageRendererFactory: IRenderMime.IRendererFactory
        abstract latexRendererFactory: IRenderMime.IRendererFactory
        abstract markdownRendererFactory: IRenderMime.IRendererFactory
        abstract svgRendererFactory: IRenderMime.IRendererFactory
        abstract textRendererFactory: IRenderMime.IRendererFactory
        abstract javaScriptRendererFactory: IRenderMime.IRendererFactory
        abstract standardRendererFactories: ReadonlyArray<IRenderMime.IRendererFactory>
...
module Mimemodel =
    ...
    type [<AllowNullLiteral>] MimeModelStatic =
        ...
        [<Emit "new $0($1...)">] abstract Create: ?options: MimeModel.IOptions -> MimeModel
    ...
    module MimeModel =
        ...
        type [<AllowNullLiteral>] IOptions =
            ...
            abstract callback: (IRenderMime.IMimeModel.ISetDataOptions -> unit) option with get, set
...
module Outputmodel =
    ...
    type [<AllowNullLiteral>] IOutputModel =
        ...
        abstract executionCount: Nbformat.ExecutionCount
        /// Whether the output is trusted.
        abstract trusted: bool with get, set
        /// Dispose of the resources used by the output model.
        abstract dispose: unit -> unit
        /// Serialize the model to JSON.
        abstract toJSON: unit -> Nbformat.IOutput
    ...
    module IOutputModel =
        ...
        type [<AllowNullLiteral>] IOptions =
            ...
            abstract value: Nbformat.IOutput with get, set
    ...
    module OutputModel =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract getData: output: Nbformat.IOutput -> JSONObject
            /// Get the metadata from an output message.
            abstract getMetadata: output: Nbformat.IOutput -> JSONObject

module Registry =
    type Contents = __@jupyterlab_services.Contents
    type Session = __@jupyterlab_services.Session
    type IRenderMime = __@jupyterlab_rendermime_interfaces.IRenderMime
    type IClientSession = __@jupyterlab_apputils.IClientSession
    type ISanitizer = __@jupyterlab_apputils.ISanitizer
    type ReadonlyJSONObject = __@phosphor_coreutils.ReadonlyJSONObject
    ...
    type [<AllowNullLiteral>] RenderMimeRegistry =
        ...
        abstract resolver: IRenderMime.IResolver option
        /// The object used to handle path opening links.
        abstract linkHandler: IRenderMime.ILinkHandler option
        /// The LaTeX typesetter for the rendermime.
        abstract latexTypesetter: IRenderMime.ILatexTypesetter option
        ...
        abstract createRenderer: mimeType: string -> IRenderMime.IRenderer
        /// Create a new mime model.  This is a convenience method.
        abstract createModel: ?options: MimeModel.IOptions -> MimeModel
        /// <summary>Create a clone of this rendermime instance.</summary>
        /// <param name="options">- The options for configuring the clone.</param>
        abstract clone: ?options: IRenderMimeRegistry.ICloneOptions -> RenderMimeRegistry
        /// <summary>Get the renderer factory registered for a mime type.</summary>
        /// <param name="mimeType">- The mime type of interest.</param>
        abstract getFactory: mimeType: string -> IRenderMime.IRendererFactory option
        ...
        /// mimeType.</param>
        abstract addFactory: factory: IRenderMime.IRendererFactory * ?rank: float -> unit
    ...
    module RenderMimeRegistry =
        ...
        type [<AllowNullLiteral>] IOptions =
            ...
            abstract initialFactories: ReadonlyArray<IRenderMime.IRendererFactory> option with get, set
            /// The sanitizer used to sanitize untrusted html inputs.
            /// 
            /// If not given, a default sanitizer will be used.
            abstract sanitizer: IRenderMime.ISanitizer option with get, set
            /// The initial resolver object.
            /// 
            /// The default is `null`.
            abstract resolver: IRenderMime.IResolver option with get, set
            /// An optional path handler.
            abstract linkHandler: IRenderMime.ILinkHandler option with get, set
            /// An optional LaTeX typesetter.
            abstract latexTypesetter: IRenderMime.ILatexTypesetter option with get, set
        ...
        type [<AllowNullLiteral>] IUrlResolverOptions =
            ...
            abstract session: U2<Session.ISession, IClientSession> with get, set
            /// The contents manager used by the resolver.
            abstract contents: Contents.IManager with get, set
...
module Tokens =
    ...
    type [<AllowNullLiteral>] IExports =
        ...
        abstract ILatexTypesetter: Token<IRenderMime.ILatexTypesetter>
    ...
    type [<AllowNullLiteral>] IRenderMimeRegistry =
        ...
        /// <summary>Create a clone of this rendermime instance.</summary>
        /// <param name="options">- The options for configuring the clone.</param>
        abstract clone: ?options: IRenderMimeRegistry.ICloneOptions -> IRenderMimeRegistry
        /// <summary>Get the renderer factory registered for a mime type.</summary>
        /// <param name="mimeType">- The mime type of interest.</param>
        abstract getFactory: mimeType: string -> IRenderMime.IRendererFactory option
        /// <summary>Add a renderer factory to the rendermime.</summary>
    ...
    type [<AllowNullLiteral>] ILatexTypesetter =
        inherit IRenderMime.ILatexTypesetter
...
module Widgets =
    ...
    type [<AllowNullLiteral>] RenderedCommon =
        inherit Widget
        inherit IRenderMime.IRenderer
        /// The mimetype being rendered.
        abstract mimeType: string
        /// The sanitizer used to sanitize untrusted html inputs.
        abstract sanitizer: IRenderMime.ISanitizer
        /// The resolver object.
        abstract resolver: IRenderMime.IResolver option
        /// The link handler.
        abstract linkHandler: IRenderMime.ILinkHandler option
        /// The latexTypesetter.
        abstract latexTypesetter: IRenderMime.ILatexTypesetter
        /// <summary>Render a mime model.</summary>
        /// <param name="model">- The mime model to render.</param>
        abstract renderModel: model: IRenderMime.IMimeModel -> Promise<unit>
        /// <summary>Render the mime model.</summary>
        /// <param name="model">- The mime model to render.</param>
        abstract render: model: IRenderMime.IMimeModel -> Promise<unit>
    ...
    type [<AllowNullLiteral>] RenderedCommonStatic =
        ...
        [<Emit "new $0($1...)">] abstract Create: options: IRenderMime.IRendererOptions -> RenderedCommon
    ...
    type [<AllowNullLiteral>] RenderedHTMLCommonStatic =
        ...
        /// <param name="options">- The options for initializing the widget.</param>
        [<Emit "new $0($1...)">] abstract Create: options: IRenderMime.IRendererOptions -> RenderedHTMLCommon
    ...
    type [<AllowNullLiteral>] RenderedHTMLStatic =
        ...
        /// <param name="options">- The options for initializing the widget.</param>
        [<Emit "new $0($1...)">] abstract Create: options: IRenderMime.IRendererOptions -> RenderedHTML
    ...
    type [<AllowNullLiteral>] RenderedLatexStatic =
        ...
        /// <param name="options">- The options for initializing the widget.</param>
        [<Emit "new $0($1...)">] abstract Create: options: IRenderMime.IRendererOptions -> RenderedLatex
    ...
    type [<AllowNullLiteral>] RenderedImageStatic =
        ...
        /// <param name="options">- The options for initializing the widget.</param>
        [<Emit "new $0($1...)">] abstract Create: options: IRenderMime.IRendererOptions -> RenderedImage
    ...
    type [<AllowNullLiteral>] RenderedMarkdownStatic =
        ...
        /// <param name="options">- The options for initializing the widget.</param>
        [<Emit "new $0($1...)">] abstract Create: options: IRenderMime.IRendererOptions -> RenderedMarkdown
    ...
    type [<AllowNullLiteral>] RenderedSVGStatic =
        ...
        /// <param name="options">- The options for initializing the widget.</param>
        [<Emit "new $0($1...)">] abstract Create: options: IRenderMime.IRendererOptions -> RenderedSVG
    ...
    type [<AllowNullLiteral>] RenderedTextStatic =
        ...
        /// <param name="options">- The options for initializing the widget.</param>
        [<Emit "new $0($1...)">] abstract Create: options: IRenderMime.IRendererOptions -> RenderedText
    ...
    type [<AllowNullLiteral>] RenderedJavaScriptStatic =
        /// <summary>Construct a new rendered text widget.</summary>
        /// <param name="options">- The options for initializing the widget.</param>
        [<Emit "new $0($1...)">] abstract Create: options: IRenderMime.IRendererOptions -> RenderedJavaScript
