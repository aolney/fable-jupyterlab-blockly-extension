...
module Blockly_python =
    ...
    module Blockly =
        ...
        module Python =
            let [<Import("text","blockly/blockly-python/Blockly/Python")>] text: Text.IExports = jsNative
            ...
            module Text =
                let [<Import("forceString_","blockly/blockly-python/Blockly/Python/text")>] forceString_: ForceString_.IExports = jsNative
...
module Blockly =
    let [<Import("*","blockly/blockly")>] blockly: Blockly.IExports = jsNative
    let [<Import("*","blockly/blockly")>] goog: Goog.IExports = jsNative

    module Blockly =
        let [<Import("ASTNode","blockly/blockly/Blockly")>] aSTNode: ASTNode.IExports = jsNative
        let [<Import("blockAnimations","blockly/blockly/Blockly")>] blockAnimations: BlockAnimations.IExports = jsNative
        let [<Import("blockRendering","blockly/blockly/Blockly")>] blockRendering: BlockRendering.IExports = jsNative
        let [<Import("BlockSvg","blockly/blockly/Blockly")>] blockSvg: BlockSvg.IExports = jsNative
        let [<Import("Bubble","blockly/blockly/Blockly")>] bubble: Bubble.IExports = jsNative
        let [<Import("Component","blockly/blockly/Blockly")>] ``component``: Component.IExports = jsNative
        let [<Import("Connection","blockly/blockly/Blockly")>] connection: Connection.IExports = jsNative
        let [<Import("ConnectionDB","blockly/blockly/Blockly")>] connectionDB: ConnectionDB.IExports = jsNative
        let [<Import("ContextMenu","blockly/blockly/Blockly")>] contextMenu: ContextMenu.IExports = jsNative
        let [<Import("Css","blockly/blockly/Blockly")>] css: Css.IExports = jsNative
        let [<Import("CursorSvg","blockly/blockly/Blockly")>] cursorSvg: CursorSvg.IExports = jsNative
        let [<Import("DropDownDiv","blockly/blockly/Blockly")>] dropDownDiv: DropDownDiv.IExports = jsNative
        let [<Import("Events","blockly/blockly/Blockly")>] events: Events.IExports = jsNative
        let [<Import("Extensions","blockly/blockly/Blockly")>] extensions: Extensions.IExports = jsNative
        let [<Import("Field","blockly/blockly/Blockly")>] field: Field.IExports = jsNative
        let [<Import("FieldAngle","blockly/blockly/Blockly")>] fieldAngle: FieldAngle.IExports = jsNative
        let [<Import("FieldCheckbox","blockly/blockly/Blockly")>] fieldCheckbox: FieldCheckbox.IExports = jsNative
        let [<Import("FieldColour","blockly/blockly/Blockly")>] fieldColour: FieldColour.IExports = jsNative
        let [<Import("FieldDate","blockly/blockly/Blockly")>] fieldDate: FieldDate.IExports = jsNative
        let [<Import("FieldDropdown","blockly/blockly/Blockly")>] fieldDropdown: FieldDropdown.IExports = jsNative
        let [<Import("FieldImage","blockly/blockly/Blockly")>] fieldImage: FieldImage.IExports = jsNative
        let [<Import("FieldLabel","blockly/blockly/Blockly")>] fieldLabel: FieldLabel.IExports = jsNative
        let [<Import("FieldLabelSerializable","blockly/blockly/Blockly")>] fieldLabelSerializable: FieldLabelSerializable.IExports = jsNative
        let [<Import("FieldMultilineInput","blockly/blockly/Blockly")>] fieldMultilineInput: FieldMultilineInput.IExports = jsNative
        let [<Import("FieldNumber","blockly/blockly/Blockly")>] fieldNumber: FieldNumber.IExports = jsNative
        let [<Import("fieldRegistry","blockly/blockly/Blockly")>] fieldRegistry: FieldRegistry.IExports = jsNative
        let [<Import("FieldTextInput","blockly/blockly/Blockly")>] fieldTextInput: FieldTextInput.IExports = jsNative
        let [<Import("FieldVariable","blockly/blockly/Blockly")>] fieldVariable: FieldVariable.IExports = jsNative
        let [<Import("FlyoutButton","blockly/blockly/Blockly")>] flyoutButton: FlyoutButton.IExports = jsNative
        let [<Import("Generator","blockly/blockly/Blockly")>] generator: Generator.IExports = jsNative
        let [<Import("Gesture","blockly/blockly/Blockly")>] gesture: Gesture.IExports = jsNative
        let [<Import("Grid","blockly/blockly/Blockly")>] grid: Grid.IExports = jsNative
        let [<Import("Msg","blockly/blockly/Blockly")>] msg: Msg.IExports = jsNative
        let [<Import("Mutator","blockly/blockly/Blockly")>] mutator: Mutator.IExports = jsNative
        let [<Import("Names","blockly/blockly/Blockly")>] names: Names.IExports = jsNative
        let [<Import("navigation","blockly/blockly/Blockly")>] navigation: Navigation.IExports = jsNative
        let [<Import("Options","blockly/blockly/Blockly")>] options: Options.IExports = jsNative
        let [<Import("Procedures","blockly/blockly/Blockly")>] procedures: Procedures.IExports = jsNative
        let [<Import("Scrollbar","blockly/blockly/Blockly")>] scrollbar: Scrollbar.IExports = jsNative
        let [<Import("Toolbox","blockly/blockly/Blockly")>] toolbox: Toolbox.IExports = jsNative
        let [<Import("Tooltip","blockly/blockly/Blockly")>] tooltip: Tooltip.IExports = jsNative
        let [<Import("Touch","blockly/blockly/Blockly")>] touch: Touch.IExports = jsNative
        let [<Import("TouchGesture","blockly/blockly/Blockly")>] touchGesture: TouchGesture.IExports = jsNative
        let [<Import("tree","blockly/blockly/Blockly")>] tree: Tree.IExports = jsNative
        let [<Import("utils","blockly/blockly/Blockly")>] utils: Utils.IExports = jsNative
        let [<Import("VariableModel","blockly/blockly/Blockly")>] variableModel: VariableModel.IExports = jsNative
        let [<Import("Variables","blockly/blockly/Blockly")>] variables: Variables.IExports = jsNative
        let [<Import("VariablesDynamic","blockly/blockly/Blockly")>] variablesDynamic: VariablesDynamic.IExports = jsNative
        let [<Import("WidgetDiv","blockly/blockly/Blockly")>] widgetDiv: WidgetDiv.IExports = jsNative
        let [<Import("Workspace","blockly/blockly/Blockly")>] workspace: Workspace.IExports = jsNative
        let [<Import("WorkspaceComment","blockly/blockly/Blockly")>] workspaceComment: WorkspaceComment.IExports = jsNative
        let [<Import("WorkspaceCommentSvg","blockly/blockly/Blockly")>] workspaceCommentSvg: WorkspaceCommentSvg.IExports = jsNative
        let [<Import("Xml","blockly/blockly/Blockly")>] xml: Xml.IExports = jsNative
        ...
        module Utils =
            let [<Import("_string","blockly/blockly/Blockly/utils")>] _string: _string.IExports = jsNative
            let [<Import("aria","blockly/blockly/Blockly/utils")>] aria: Aria.IExports = jsNative
            let [<Import("colour","blockly/blockly/Blockly/utils")>] colour: Colour.IExports = jsNative
            let [<Import("Coordinate","blockly/blockly/Blockly/utils")>] coordinate: Coordinate.IExports = jsNative
            let [<Import("dom","blockly/blockly/Blockly/utils")>] dom: Dom.IExports = jsNative
            let [<Import("IdGenerator","blockly/blockly/Blockly/utils")>] idGenerator: IdGenerator.IExports = jsNative
            let [<Import("math","blockly/blockly/Blockly/utils")>] math: Math.IExports = jsNative
            let [<Import("object","blockly/blockly/Blockly/utils")>] ``object``: Object.IExports = jsNative
            let [<Import("Size","blockly/blockly/Blockly/utils")>] size: Size.IExports = jsNative
            let [<Import("style","blockly/blockly/Blockly/utils")>] style: Style.IExports = jsNative
            let [<Import("svgPaths","blockly/blockly/Blockly/utils")>] svgPaths: SvgPaths.IExports = jsNative
            let [<Import("uiMenu","blockly/blockly/Blockly/utils")>] uiMenu: UiMenu.IExports = jsNative
            let [<Import("xml","blockly/blockly/Blockly/utils")>] xml: Xml.IExports = jsNative
        ...
        module User =
            let [<Import("keyMap","blockly/blockly/Blockly/user")>] keyMap: KeyMap.IExports = jsNative
        ...
        module Tree =
            let [<Import("BaseNode","blockly/blockly/Blockly/tree")>] baseNode: BaseNode.IExports = jsNative
        ...
        module BlockRendering =
            let [<Import("Debug","blockly/blockly/Blockly/blockRendering")>] debug: Debug.IExports = jsNative
            let [<Import("Types","blockly/blockly/Blockly/blockRendering")>] types: Types = jsNative
    ...
    module Goog =
        let [<Import("getMsg","blockly/blockly/goog")>] getMsg: GetMsg.IExports = jsNative
