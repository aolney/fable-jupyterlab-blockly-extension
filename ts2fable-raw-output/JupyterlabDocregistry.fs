...
module Context =
    ...
    type ServiceManager = __@jupyterlab_services.ServiceManager
    ...
    type ClientSession = __@jupyterlab_apputils.ClientSession
    type IClientSession = __@jupyterlab_apputils.IClientSession
    type ModelDB = __@jupyterlab_observables.ModelDB
    ...
    type [<AllowNullLiteral>] Context<'T> =
        inherit DocumentRegistry.IContext<'T>
        /// A signal emitted when the path changes.
        abstract pathChanged: ISignal<Context<'T>, string>
        /// A signal emitted when the model is saved or reverted.
        abstract fileChanged: ISignal<Context<'T>, Contents.IModel>
        /// A signal emitted on the start and end of a saving operation.
        abstract saveState: ISignal<Context<'T>, DocumentRegistry.SaveState>
        ...
        abstract contentsModel: Contents.IModel option
        ...
        abstract urlResolver: IRenderMime.IResolver
        ...
        abstract createCheckpoint: unit -> Promise<Contents.ICheckpointModel>
        ...
        abstract listCheckpoints: unit -> Promise<ResizeArray<Contents.ICheckpointModel>>
        ...
        abstract addSibling: widget: Widget * ?options: DocumentRegistry.IOpenOptions -> IDisposable
    ...
    module Context =
        ...
        type [<AllowNullLiteral>] IOptions<'T> =
            ...
            abstract manager: ServiceManager.IManager with get, set
            /// The model factory used to create the model.
            abstract factory: DocumentRegistry.IModelFactory<'T> with get, set
            ...
            abstract modelDBFactory: ModelDB.IFactory option with get, set
...
module Default =
    ...
    type ISignal = __@phosphor_signaling.ISignal
    type Widget = __@phosphor_widgets.Widget
    type MainAreaWidget = __@jupyterlab_apputils.MainAreaWidget
    ...
    type DocumentRegistry = Index.DocumentRegistry
    type IDocumentWidget = Index.IDocumentWidget
    ...
    type [<AllowNullLiteral>] DocumentModel =
        inherit CodeEditor.Model
        inherit DocumentRegistry.ICodeModel
        /// A signal emitted when the document content changes.
        abstract contentChanged: ISignal<DocumentModel, unit>
        /// A signal emitted when the document state changes.
        abstract stateChanged: ISignal<DocumentModel, IChangedArgs<obj option>>
        ...
        abstract triggerStateChange: args: IChangedArgs<obj option> -> unit
    ...
    type [<AllowNullLiteral>] TextModelFactory =
        inherit DocumentRegistry.CodeModelFactory
        ...
        abstract createNew: ?languagePreference: string * ?modelDB: IModelDB -> DocumentRegistry.ICodeModel
    ...
    type [<AllowNullLiteral>] ABCWidgetFactory<'T, 'U> =
        inherit DocumentRegistry.IWidgetFactory<'T, 'U>
        /// A signal emitted when a widget is created.
        abstract widgetCreated: ISignal<DocumentRegistry.IWidgetFactory<'T, 'U>, 'T>
        /// Get whether the model factory has been disposed.
        abstract isDisposed: bool
        ...
        abstract createNew: context: DocumentRegistry.IContext<'U> * ?source: 'T -> 'T
        /// Create a widget for a context.
        abstract createNewWidget: context: DocumentRegistry.IContext<'U> * ?source: 'T -> 'T
        /// Default factory for toolbar items to be added after the widget is created.
        abstract defaultToolbarFactory: widget: 'T -> ResizeArray<DocumentRegistry.IToolbarItem>

    /// The default implementation of a widget factory.
    type [<AllowNullLiteral>] ABCWidgetFactoryStatic =
        /// Construct a new `ABCWidgetFactory`.
        [<Emit "new $0($1...)">] abstract Create: options: DocumentRegistry.IWidgetFactoryOptions<'T> -> ABCWidgetFactory<'T, 'U>
    ...
    type [<AllowNullLiteral>] DocumentWidget<'T, 'U> =
        inherit MainAreaWidget<'T>
        inherit IDocumentWidget<'T, 'U>
    ...
    module DocumentWidget =
        ...
        type [<AllowNullLiteral>] IOptions<'T, 'U> =
            inherit MainAreaWidget.IOptions<'T>
            abstract context: DocumentRegistry.IContext<'U> with get, set
...
module Mimedocument =
    ...
    type [<AllowNullLiteral>] MimeContent =
        ...
        abstract renderer: IRenderMime.IRenderer
    ...
    module MimeContent =
        ...
        type [<AllowNullLiteral>] IOptions =
            /// Context
            abstract context: DocumentRegistry.IContext<DocumentRegistry.IModel> with get, set
            /// The renderer instance.
            abstract renderer: IRenderMime.IRenderer with get, set
            /// The mime type.
    ...
    type [<AllowNullLiteral>] MimeDocument =
        inherit DocumentWidget<MimeContent>
        abstract setFragment: fragment: string -> unit
    ...
    type [<AllowNullLiteral>] MimeDocumentFactory =
        ...
        abstract createNewWidget: context: DocumentRegistry.Context -> MimeDocument
    ...
    module MimeDocumentFactory =
        ...
        type [<AllowNullLiteral>] IOptions<'T> =
            ...
            abstract primaryFileType: DocumentRegistry.IFileType with get, set
...
module Registry =
    ...
    type IDisposable = __@phosphor_disposable.IDisposable
    type ISignal = __@phosphor_signaling.ISignal
    type DockLayout = __@phosphor_widgets.DockLayout
    type Widget = __@phosphor_widgets.Widget
    type IClientSession = __@jupyterlab_apputils.IClientSession
    type Toolbar = __@jupyterlab_apputils.Toolbar
    type CodeEditor = __@jupyterlab_codeeditor.CodeEditor
    type IChangedArgsGeneric = __@jupyterlab_coreutils.IChangedArgs
    type IModelDB = __@jupyterlab_observables.IModelDB
    type IRenderMime = __@jupyterlab_rendermime_interfaces.IRenderMime
    ...
    type [<AllowNullLiteral>] DocumentRegistry =
        ...
        abstract getKernelPreference: path: string * widgetName: string * ?kernel: obj -> IClientSession.IKernelPreference option
    ...
    module DocumentRegistry =
        ...
        type [<AllowNullLiteral>] IContext<'T> =
            ...
            abstract fileChanged: ISignal<IContext<'T>, Contents.IModel> with get, set
            /// A signal emitted on the start and end of a saving operation.
        ...
        type [<AllowNullLiteral>] IOpenOptions =
            ...
            abstract mode: DockLayout.InsertMode option with get, set
    ...
    type [<AllowNullLiteral>] IDocumentWidget<'T, 'U> =
        ...
        abstract toolbar: Toolbar<Widget>
        /// Set URI fragment identifier.
        abstract setFragment: fragment: string -> unit
