...
module Dataconnector =
    type IDataConnector = Interfaces.IDataConnector
...
module Interfaces =
    type CommandRegistry = __@phosphor_commands.CommandRegistry
    type ReadonlyJSONObject = __@phosphor_coreutils.ReadonlyJSONObject
    type ReadonlyJSONValue = __@phosphor_coreutils.ReadonlyJSONValue
    type IDisposable = __@phosphor_disposable.IDisposable
    type IObservableDisposable = __@phosphor_disposable.IObservableDisposable
    type ISignal = __@phosphor_signaling.ISignal
...
module Poll =
    ...
    type [<AllowNullLiteral>] Poll<'T, 'U, 'V> =
        ...
        abstract frequency: IPoll.Frequency with get, set
        /// Whether the poll is disposed.
        abstract isDisposed: bool
        ...
        abstract ticked: ISignal<Poll<'T, 'U, 'V>, IPoll.State<'T, 'U, 'V>>
        /// Dispose the poll.
        abstract dispose: unit -> unit
    ...
    module Poll =
        ...
        type [<AllowNullLiteral>] Factory<'T, 'U, 'V> =
            [<Emit "$0($1...)">] abstract Invoke: state: IPoll.State<'T, 'U, 'V> -> Promise<'T>
...
module Ratelimiter =
    type PromiseDelegate = __@phosphor_coreutils.PromiseDelegate
    ...
    type [<AllowNullLiteral>] RateLimiter<'T, 'U> =
        ...
        abstract poll: Poll<'T, 'U, string> with get, set
...
module Restorablepool =
    type IObservableDisposable = __@phosphor_disposable.IObservableDisposable
    type ISignal = __@phosphor_signaling.ISignal
    type IObjectPool = Interfaces.IObjectPool
    type IRestorable = Interfaces.IRestorable
...
module Settingregistry =
    ...
    type [<AllowNullLiteral>] ISchemaValidator =
        ...
        /// `true`.</param>
        abstract validateData: plugin: ISettingRegistry.IPlugin * ?populate: bool -> ResizeArray<ISchemaValidator.IError> option
    ...
    type [<AllowNullLiteral>] Settings =
        inherit ISettingRegistry.ISettings
        /// The plugin name.
        abstract id: string
    ...
    module SettingRegistry =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract reconcileShortcuts: defaults: ResizeArray<ISettingRegistry.IShortcut> * user: ResizeArray<ISettingRegistry.IShortcut> -> ResizeArray<ISettingRegistry.IShortcut>

        /// The instantiation options for a setting registry
        type [<AllowNullLiteral>] IOptions =
            /// The data connector used by the setting registry.
            abstract connector: IDataConnector<ISettingRegistry.IPlugin, string> with get, set
            /// Preloaded plugin data to populate the setting registry.
            abstract plugins: ResizeArray<ISettingRegistry.IPlugin> option with get, set
    ...
    module Settings =
        ...
        type [<AllowNullLiteral>] IOptions =
            ...
            abstract plugin: ISettingRegistry.IPlugin with get, set
    ...
    module Private =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract annotatedDefaults: schema: ISettingRegistry.ISchema * plugin: string -> string
            /// Returns an annotated (JSON with comments) version of a plugin's
            /// setting data.
            abstract annotatedPlugin: plugin: ISettingRegistry.IPlugin * data: JSONObject -> string
            /// Create a fully extrapolated default value for a root key in a schema.
            abstract reifyDefault: schema: ISettingRegistry.IProperty * ?root: string -> JSONValue option
